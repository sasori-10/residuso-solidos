...
// Si solo viene un rol (user) se bloquea edición visual de rol
const singleRoleOnly = computed(() => roles.value.length === 1 && roles.value[0].toLowerCase() === 'user');
                                    ...
                                    <tr v-for="user in users" :key="user.id" class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="py-3 px-4 text-center">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                <button v-if="canDelete" @click="deleteUser(user)" class="text-red-600 hover:text-red-800 transition">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 relative animate__animated animate__fadeInUp animate__faster">
                ...
                <form @submit.prevent="saveUser" class="space-y-4">
                    ...
                    <div>
                        ...
                        <template v-if="singleRoleOnly">
                            <input type="text" v-model="form.role" disabled class="w-full rounded-lg border border-gray-200 bg-gray-100 px-4 py-2.5 text-gray-600" />
                        </template>
